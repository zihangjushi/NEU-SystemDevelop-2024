			...
			<el-aside class="menu-with-shadow" width="240px" style="color: rgb(255,255,255)">
				<el-menu :default-openeds="['3']">
					...
					<el-sub-menu index="3">
						...
						<el-menu-item index="3-3" @click="routeToNewsManage()"><el-icon>
								<Orange />
	...
	export default {
		...
		setup() {
			...
			const addCourse = () => {
				...
				if (!courseForm.courseName || !courseForm.description || !courseForm.courseOrder || !courseForm
					.author || !previewImageUrl.value || !previewVideoUrl.value) {
					alert('请输入完整后参加');
					return;
				}
