			...
			<el-container>
				...
				<el-main>
					...
					<div style="text-align: left;">
						...
						<el-date-picker v-model="inputCreateDate" type="date" placeholder="选择日期"
						...
						<!-- 查询和重置按钮 -->
						<el-button type="primary" @click="searchUser" style="margin-left: 15px;"
					...
					<el-row style="text-align: left;">
						<el-button type="primary" @click="addButton" plain icon="Plus"
							style="margin-top: 5px">新增</el-button>
						<el-button type="danger" @click="confirmDelete" plain icon="Delete"
							style="margin-top: 5px">删除</el-button>
						<el-button type="warning" @click="exportUsers" plain icon="Download"
							...
							<el-col :span="10" class="form-col">
								<el-form-item label="手机号码" prop="phoneNumber" size="large" style="height: 60px">
									<el-input id="phoneNumber" type="text" v-model="addForm.phoneNumber"
										placeholder="请输入手机号码" style="width: 270px;height: 40px" />
								</el-form-item>
							</el-col>
							<el-col :span="10" class="form-col">
						...
						<el-row :gutter="3" class="form-row"> <!-- 这里的 gutter 控制列之间的间距 -->
							<el-col :span="10" class="form-col">
								<el-form-item label="公司名称" prop="company" size="large" style="height: 60px">
									<el-cascader v-model="addForm.companyId" :options="companyOptions"
										placeholder="请选择公司" clearable style="width:270px" />
								</el-form-item>
							</el-col>
							<el-col :span="10" class="form-col">
						...
						<el-row :gutter="3" class="form-row"> <!-- 这里的 gutter 控制列之间的间距 -->
							...
							<el-col :span="10" class="form-col">
								<el-form-item label="描述" prop="description" size="large" style="height: 60px">
									<el-input v-model="addForm.description" style="width: 300px; height: 50px" :rows="2"
				...
				<el-dialog v-model="updateDialogVisible" title="修改用户" :close-on-click-modal="true"
					...
					<el-form ref="form" :model="updateForm" :rules="rules" label-width="150px" label-position="top">
						<el-row :gutter="3" class="form-row"> <!-- 这里的 gutter 控制列之间的间距 -->
							<el-col :span="10" class="form-col">
								<el-form-item label="用户昵称" prop="userName" size="large" style="height: 60px">
									<el-input id="userName" type="text" v-model="updateForm.userName"
										placeholder="请输入用户昵称" style="width: 270px;height: 40px" />
								</el-form-item>
							</el-col>
							<el-col :span="10" class="form-col">
								<el-form-item label="归属部门" prop="department" size="large" style="height: 60px">
									<el-cascader v-model="updateForm.departmentId"
										:options="transformedDepartmentOptions" placeholder="请选择部门" clearable
										style="width:270px" />
								</el-form-item>
							</el-col>
						</el-row>
						<el-row :gutter="3" class="form-row"> <!-- 这里的 gutter 控制列之间的间距 -->
							<el-col :span="10" class="form-col">
								<el-form-item label="手机号码" prop="phoneNumber" size="large" style="height: 60px">
									<el-input id="phoneNumber" type="text" v-model="updateForm.phoneNumber"
										placeholder="请输入手机号码" style="width: 270px;height: 40px" />
								</el-form-item>
							</el-col>
							<el-col :span="10" class="form-col">
						...
						<el-row :gutter="3" class="form-row"> <!-- 这里的 gutter 控制列之间的间距 -->
							<el-col :span="10" class="form-col">
								<el-form-item label="用户性别" prop="gender" size="large" style="  height: 60px">
									<el-cascader v-model="updateForm.gender" :options="genderOptions"
										placeholder="请选择用户性别" style="width:270px" clearable />
								</el-form-item>
							</el-col>
							<el-col :span="10" class="form-col">
								<el-form-item label="状态" prop="enabled" size="large" style=" height: 60px">
						...
						<el-row :gutter="3" class="form-row"> <!-- 这里的 gutter 控制列之间的间距 -->
							<el-col :span="10" class="form-col">
								<el-form-item label="岗位" prop="career" size="large" style="height: 60px">
									<el-cascader v-model="updateForm.career" :options="careerOptions"
										placeholder="请选择岗位" style="width:270px" clearable />
								</el-form-item>
							</el-col>
							<el-col :span="10" class="form-col">
								<el-form-item label="角色" prop="role" size="large" style="height: 60px">
									<el-cascader v-model="updateForm.role" :options="roleOptions" placeholder="请选择权限"
										style="width:270px" clearable />
								</el-form-item>
							</el-col>
						</el-row>
						<el-form-item label="描述" prop="description" size="large"
							style="height: 80px; width: 800px; justify-content: center; margin-left: 17%">
							<el-input v-model="updateForm.description" style="width: 600px; height: 80px" :rows="2"
								type="textarea" placeholder="Please input" />
						</el-form-item>
					</el-form>
	...
	export default {
		...
		setup() {
			...
			const searchUser = () => {
				...
				if (!inputUserName.value && !inputPhoneNumber.value && !inputCreateDate.value && !enabled.value) {
					...
					filteredUserTable.value = userTable.value.filter(user => {
						...
						return (
							(!inputUserName.value || (user.userName && user.userName.includes(inputUserName
								.value))) &&
							(!inputPhoneNumber.value || (user.phoneNumber && user.phoneNumber.includes(
								inputPhoneNumber.value))) &&
			...
			const transformNumToDept = num => {
				if (num == 0) return "无"
				else if (num == 1) return "运维部门"
				else if (num == 2) return "测试部门"
				else if (num == 3) return "市场部门"
				else if (num == 4) return "研发部门"
				else if (num == 5) return "财务部门"
			}
